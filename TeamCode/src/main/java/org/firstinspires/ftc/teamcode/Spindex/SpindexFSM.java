...
public class SpindexFSM {
    ...
    public String purpleStr = "Purple";
    public String emptyStr = "Empty";
    ...
    public SpindexFSM(HWMapSpindex hwMap, Telemetry telemetry) {
        ...
        detectedMotif[0] = "Empty";
        detectedMotif[1] = "Empty";
        detectedMotif[2] = "Empty";
    }
   ...
   //     telemetry.addData("Slot 2", detectedMotif[2]);
    ...
    public boolean slotIsGreen(int pocket) {

        return detectedMotif[pocket].equals(greenStr);
    }

    public boolean slotIsPurple(int pocket) {
        return detectedMotif[pocket].equals(purpleStr);
    }

    public boolean slotIsEmpty(int pocket) {
        String m = detectedMotif[pocket];
        return m.equals(emptyStr);
    }
