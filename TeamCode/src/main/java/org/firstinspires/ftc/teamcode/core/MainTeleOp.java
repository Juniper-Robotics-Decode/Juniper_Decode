...
/*
        ...
        while (opModeIsActive()) {
            ...
            intakeFSM.updateState(gamepadE1.wasJustPressed(GamepadKeys.Button.DPAD_UP), gamepadE1.getButton(GamepadKeys.Button.DPAD_LEFT), gamepadE1.wasJustPressed(GamepadKeys.Button.DPAD_DOWN));
